defmodule Project1 do
  ...
  def task do
    ...
    create_actors(no_of_cores, work_range, start, ending, self())             #Create the "boss" and use the boss to assign tasks to "workers"
  ...
  def create_actors(no_of_cores, work_range, start, ending, pid) when no_of_cores <= 1 do
